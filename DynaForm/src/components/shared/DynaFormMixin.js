...
export default {
	...
	props: [
		...
		"data", 
		"layout",
		"secondaryLayoutTitleCollapsed",
		"secondaryLayoutTitleExpanded",
		"secondaryLayoutSubtitle",
		"secondaryLayoutIsCollapsed",
		"secondaryLayoutCustomClasses",
		"secondaryLayout",
		"formSettings",
		"isMasterForm",
		"name",
  ...
  data() {
    return {
			...
			secondaryLayoutTitleCollapsed: this.secondaryLayoutTitleCollapsed,
			secondaryLayoutTitleExpanded: this.secondaryLayoutTitleExpanded,
			secondaryLayoutSubtitle: this.secondaryLayoutSubtitle,			
			secondaryLayoutIsCollapsed: this.secondaryLayoutIsCollapsed,
			secondaryLayoutCustomClasses: this.secondaryLayoutCustomClasses,
			secondaryLayout: this.secondaryLayout,
