<template>
		...
		>
			...
			<b-form-select 
				...
				:disabled="(computedReadOnly == true && DisplayValues.readonlyOverride == null) || (DisplayValues.readonlyOverride == true)"
				:multiple="multi"
				:dir="DisplayValues.align"
				:class="[ (computedReadOnly == true && DisplayValues.readonlyOverride == null) || (DisplayValues.readonlyOverride == true) ? 'readonly' : '', DisplayValues.customClasses, 'form-control']"
